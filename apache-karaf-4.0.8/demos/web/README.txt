...
[uninstalled] [4.0.8 ] wrapper           standard-4.0.8      Provide OS integration
[uninstalled] [4.0.8 ] obr               standard-4.0.8      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.0.8 ] config            standard-4.0.8      Provide OSGi ConfigAdmin support
[uninstalled] [4.0.8 ] region            standard-4.0.8      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.0.8      Provide Jetty engine support
[uninstalled] [4.0.8 ] http              standard-4.0.8      Implementation of the OSGI HTTP Service
[uninstalled] [4.0.8 ] http-whiteboard   standard-4.0.8      Provide HTTP Whiteboard pattern support
[uninstalled] [4.0.8 ] war               standard-4.0.8      Turn Karaf as a full WebContainer
[uninstalled] [4.0.8 ] deployers         standard-4.0.8      Provide Karaf deployer
[uninstalled] [4.0.8 ] kar               standard-4.0.8      Provide KAR (KARaf archive) support
[uninstalled] [4.0.8 ] webconsole-base   standard-4.0.8      Base support of the Karaf WebConsole
[uninstalled] [4.0.8 ] webconsole        standard-4.0.8      Karaf WebConsole for administration and monitoring
[uninstalled] [4.0.8 ] ssh               standard-4.0.8      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.0.8.war, and
